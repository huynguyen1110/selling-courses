      ...
      <View style={[styles.secondary_container]}>
        <ScrollView>
          ...
          <View style={[styles.horizontal_container, styles.item_space_between, styles.small_margin_vertical]}>
            <View>
              <TouchableOpacity style={[buttonStyles.square_button, styles.background_purple]}>
                <View>
                  <Svg style={[styles.large_icon_style]} viewBox="0 0 576 512"><Path d="M0 24C0 10.7 10.7 0 24 0H69.5c22 0 41.5 12.8 50.6 32h411c26.3 0 45.5 25 38.6 50.4l-41 152.3c-8.5 31.4-37 53.3-69.5 53.3H170.7l5.4 28.5c2.2 11.3 12.1 19.5 23.6 19.5H488c13.3 0 24 10.7 24 24s-10.7 24-24 24H199.7c-34.6 0-64.3-24.6-70.7-58.5L77.4 54.5c-.7-3.8-4-6.5-7.9-6.5H24C10.7 48 0 37.3 0 24zM128 464a48 48 0 1 1 96 0 48 48 0 1 1 -96 0zm336-48a48 48 0 1 1 0 96 48 48 0 1 1 0-96z" /></Svg>
                </View>
              </TouchableOpacity>
              <Text style={[styles.text_center, styles.text_content]}>Ưu đãi</Text>
            </View>

            <View>
              <TouchableOpacity style={[buttonStyles.square_button, styles.background_green]}>
                <View>
                  <Svg style={[styles.large_icon_style]} viewBox="0 0 576 512"><Path d="M249.6 471.5c10.8 3.8 22.4-4.1 22.4-15.5V78.6c0-4.2-1.6-8.4-5-11C247.4 52 202.4 32 144 32C93.5 32 46.3 45.3 18.1 56.1C6.8 60.5 0 71.7 0 83.8V454.1c0 11.9 12.8 20.2 24.1 16.5C55.6 460.1 105.5 448 144 448c33.9 0 79 14 105.6 23.5zm76.8 0C353 462 398.1 448 432 448c38.5 0 88.4 12.1 119.9 22.6c11.3 3.8 24.1-4.6 24.1-16.5V83.8c0-12.1-6.8-23.3-18.1-27.6C529.7 45.3 482.5 32 432 32c-58.4 0-103.4 20-123 35.6c-3.3 2.6-5 6.8-5 11V456c0 11.4 11.7 19.3 22.4 15.5z" /></Svg>
                </View>
              </TouchableOpacity>
              <Text style={[styles.text_center, styles.text_content]}>Combo</Text>
            </View>

            <View>
              <TouchableOpacity style={[buttonStyles.square_button, styles.background_red]}>
                <Svg style={[styles.large_icon_style]} viewBox="0 0 448 512"><Path d="M159.3 5.4c7.8-7.3 19.9-7.2 27.7 .1c27.6 25.9 53.5 53.8 77.7 84c11-14.4 23.5-30.1 37-42.9c7.9-7.4 20.1-7.4 28 .1c34.6 33 63.9 76.6 84.5 118c20.3 40.8 33.8 82.5 33.8 111.9C448 404.2 348.2 512 224 512C98.4 512 0 404.1 0 276.5c0-38.4 17.8-85.3 45.4-131.7C73.3 97.7 112.7 48.6 159.3 5.4zM225.7 416c25.3 0 47.7-7 68.8-21c42.1-29.4 53.4-88.2 28.1-134.4c-4.5-9-16-9.6-22.5-2l-25.2 29.3c-6.6 7.6-18.5 7.4-24.7-.5c-16.5-21-46-58.5-62.8-79.8c-6.3-8-18.3-8.1-24.7-.1c-33.8 42.5-50.8 69.3-50.8 99.4C112 375.4 162.6 416 225.7 416z" /></Svg>
              </TouchableOpacity>
              <Text style={[styles.text_center, styles.text_content]}>Bán chạy</Text>
            </View>
          </View>
          {/* button area */}
